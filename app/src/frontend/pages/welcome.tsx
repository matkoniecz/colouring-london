...
const Welcome = () => (
    <div className="section-body welcome">
        ...
        <p>
            Colouring London is also the prototype for the The Colouring Cities Research Programme (CCRP), led by the Alan Turing Institute. It involves <a href="https://github.com/colouring-cities/colouring-cities.github.io">an international consortium of academic institutions</a> involved
